...
namespace TransferZero.Sdk.Api
{
    ...
    public interface IRecipientsApi : IApiAccessor
    {
        ...
        /// <param name="state">Allows filtering results by &#x60;state&#x60; of recipient. See [API Documentation - Recipient state](https://docs.transferzero.com/docs/transaction-flow/#state) for possible states.  Example: &#x60;/v1/recipients?state[]&#x3D;error&amp;state[]&#x3D;initial&#x60; (optional)</param>
