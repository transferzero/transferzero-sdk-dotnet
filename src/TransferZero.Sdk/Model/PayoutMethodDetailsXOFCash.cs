...
namespace TransferZero.Sdk.Model
{
    ...
    public partial class PayoutMethodDetailsXOFCash :  IEquatable<PayoutMethodDetailsXOFCash>, IValidatableObject
    {
        ...
        public PayoutMethodDetailsXOFCash(string firstName = default(string), string lastName = default(string), string phoneNumber = default(string), PayoutMethodCashProviderEnum cashProvider = default(PayoutMethodCashProviderEnum), PayoutMethodCountryEnum country = default(PayoutMethodCountryEnum), DateTime? birthDate = default(DateTime?))
        {
