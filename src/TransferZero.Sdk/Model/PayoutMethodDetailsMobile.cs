...
namespace TransferZero.Sdk.Model
{
    ...
    public partial class PayoutMethodDetailsMobile :  IEquatable<PayoutMethodDetailsMobile>, IValidatableObject
    {
        ...
        public PayoutMethodDetailsMobile(string firstName = default(string), string lastName = default(string), string phoneNumber = default(string), PayoutMethodMobileProviderEnum mobileProvider = default(PayoutMethodMobileProviderEnum), DateTime? birthDate = default(DateTime?))
        {
