...
namespace TransferZero.Sdk.Model
{
    ...
    public partial class Sender :  IEquatable<Sender>, IValidatableObject
    {
        ...
        public enum LegalEntityTypeEnum
        {
            ...
            /// <summary>
            /// Enum Mto for value: mto
            /// </summary>
            [EnumMember(Value = "mto")]
            Mto = 12
        ...
        /// <param name="phoneCountry">Phone country of sender in 2-character alpha ISO 3166-2 country format.</param>
        ...
        /// <param name="companyOfficeNumber">Phone number of company office (without country callcode, used only with a Business sender).</param>
        /// <param name="companyOfficeNumberCountry">Phone number country of company office in 2-character alpha ISO 3166-2 country format (used only with a Business sender).</param>
        /// <param name="amlOfficerEmail">Email address of AML Officer (used only with a Business sender).</param>
        /// <param name="amlOfficerPhone">Phone number of AML Officer (without country callcode, used only with a Business sender).</param>
        /// <param name="amlOfficerPhoneCountry">Phone number country of AML Officer in 2-character alpha ISO 3166-2 country format (used only with a Business sender).</param>
        /// <param name="companyWebsiteUrl">Company website URL (used only with a Business sender).</param>
        /// <param name="taxIdentificationNo">Tax Identification Number (used only with a Business sender).</param>
        /// <param name="numberOfEmployeesInCompany">Number of employees in company (used only with a Business sender).</param>
        ...
        /// </summary>
        /// <value>Phone number of company office (without country callcode, used only with a Business sender)</value>
        [DataMember(Name="company_office_number", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Phone number country of company office in 2-character alpha ISO 3166-2 country format (used only with a Business sender)</value>
        [DataMember(Name="company_office_number_country", EmitDefaultValue=false)]
        public string CompanyOfficeNumberCountry { get; set; }

        /// <summary>
        /// Email address of AML Officer (used only with a Business sender)
        /// </summary>
        /// <value>Email address of AML Officer (used only with a Business sender)</value>
        [DataMember(Name="aml_officer_email", EmitDefaultValue=false)]
        public string AmlOfficerEmail { get; set; }

        /// <summary>
        /// Phone number of AML Officer (without country callcode, used only with a Business sender)
        /// </summary>
        /// <value>Phone number of AML Officer (without country callcode, used only with a Business sender)</value>
        [DataMember(Name="aml_officer_phone", EmitDefaultValue=false)]
        public string AmlOfficerPhone { get; set; }

        /// <summary>
        /// Phone number country of AML Officer in 2-character alpha ISO 3166-2 country format (used only with a Business sender)
        /// </summary>
        /// <value>Phone number country of AML Officer in 2-character alpha ISO 3166-2 country format (used only with a Business sender)</value>
        [DataMember(Name="aml_officer_phone_country", EmitDefaultValue=false)]
        public string AmlOfficerPhoneCountry { get; set; }

        /// <summary>
        /// Company website URL (used only with a Business sender)
        /// </summary>
        /// <value>Company website URL (used only with a Business sender)</value>
        [DataMember(Name="company_website_url", EmitDefaultValue=false)]
        public string CompanyWebsiteUrl { get; set; }

        /// <summary>
        /// Tax Identification Number (used only with a Business sender)
        /// </summary>
        /// <value>Tax Identification Number (used only with a Business sender)</value>
        [DataMember(Name="tax_identification_no", EmitDefaultValue=false)]
        public string TaxIdentificationNo { get; set; }

        /// <summary>
        /// Number of employees in company (used only with a Business sender)
        /// </summary>
        /// <value>Number of employees in company (used only with a Business sender)</value>
        [DataMember(Name="number_of_employees_in_company", EmitDefaultValue=false)]
        public string NumberOfEmployeesInCompany { get; set; }

        /// <summary>
        /// List of countries of operation (used only with a Business sender)
        /// </summary>
        /// <value>List of countries of operation (used only with a Business sender)</value>
        [DataMember(Name="list_of_countries_of_operation", EmitDefaultValue=false)]
        public List<string> ListOfCountriesOfOperation { get; set; }

        /// <summary>
        /// Estimated annual turnover (in USD or equivalent, used only with a Business sender)
        /// </summary>
        /// <value>Estimated annual turnover (in USD or equivalent, used only with a Business sender)</value>
        [DataMember(Name="estimated_annual_revenue_turnover", EmitDefaultValue=false)]
        public string EstimatedAnnualRevenueTurnover { get; set; }

        /// <summary>
        /// Declaration that the signatory is authorised (used only with a Business sender)
        /// </summary>
        /// <value>Declaration that the signatory is authorised (used only with a Business sender)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CompanyOfficeNumber: ").Append(CompanyOfficeNumber).Append("\n");
            sb.Append("  CompanyOfficeNumberCountry: ").Append(CompanyOfficeNumberCountry).Append("\n");
            sb.Append("  AmlOfficerEmail: ").Append(AmlOfficerEmail).Append("\n");
            sb.Append("  AmlOfficerPhone: ").Append(AmlOfficerPhone).Append("\n");
            sb.Append("  AmlOfficerPhoneCountry: ").Append(AmlOfficerPhoneCountry).Append("\n");
            sb.Append("  CompanyWebsiteUrl: ").Append(CompanyWebsiteUrl).Append("\n");
            sb.Append("  TaxIdentificationNo: ").Append(TaxIdentificationNo).Append("\n");
            sb.Append("  NumberOfEmployeesInCompany: ").Append(NumberOfEmployeesInCompany).Append("\n");
            sb.Append("  ListOfCountriesOfOperation: ").Append(ListOfCountriesOfOperation).Append("\n");
            sb.Append("  EstimatedAnnualRevenueTurnover: ").Append(EstimatedAnnualRevenueTurnover).Append("\n");
        ...
        public bool Equals(Sender input)
        {
            ...
            return 
                ...
                (
                    this.CompanyOfficeNumber == input.CompanyOfficeNumber ||
                    (this.CompanyOfficeNumber != null &&
                    this.CompanyOfficeNumber.Equals(input.CompanyOfficeNumber))
                ) && 
                (
                    this.CompanyOfficeNumberCountry == input.CompanyOfficeNumberCountry ||
                    (this.CompanyOfficeNumberCountry != null &&
                    this.CompanyOfficeNumberCountry.Equals(input.CompanyOfficeNumberCountry))
                ) && 
                (
                    this.AmlOfficerEmail == input.AmlOfficerEmail ||
                    (this.AmlOfficerEmail != null &&
                    this.AmlOfficerEmail.Equals(input.AmlOfficerEmail))
                ) && 
                (
                    this.AmlOfficerPhone == input.AmlOfficerPhone ||
                    (this.AmlOfficerPhone != null &&
                    this.AmlOfficerPhone.Equals(input.AmlOfficerPhone))
                ) && 
                (
                    this.AmlOfficerPhoneCountry == input.AmlOfficerPhoneCountry ||
                    (this.AmlOfficerPhoneCountry != null &&
                    this.AmlOfficerPhoneCountry.Equals(input.AmlOfficerPhoneCountry))
                ) && 
                (
                    this.CompanyWebsiteUrl == input.CompanyWebsiteUrl ||
                    (this.CompanyWebsiteUrl != null &&
                    this.CompanyWebsiteUrl.Equals(input.CompanyWebsiteUrl))
                ) && 
                (
                    this.TaxIdentificationNo == input.TaxIdentificationNo ||
                    (this.TaxIdentificationNo != null &&
                    this.TaxIdentificationNo.Equals(input.TaxIdentificationNo))
                ) && 
                (
                    this.NumberOfEmployeesInCompany == input.NumberOfEmployeesInCompany ||
                    (this.NumberOfEmployeesInCompany != null &&
                    this.NumberOfEmployeesInCompany.Equals(input.NumberOfEmployeesInCompany))
                ) && 
                (
                    this.ListOfCountriesOfOperation == input.ListOfCountriesOfOperation ||
                    this.ListOfCountriesOfOperation != null &&
                    this.ListOfCountriesOfOperation.SequenceEqual(input.ListOfCountriesOfOperation)
                ) && 
                (
                    this.EstimatedAnnualRevenueTurnover == input.EstimatedAnnualRevenueTurnover ||
                    (this.EstimatedAnnualRevenueTurnover != null &&
                    this.EstimatedAnnualRevenueTurnover.Equals(input.EstimatedAnnualRevenueTurnover))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CompanyOfficeNumber != null)
                    hashCode = hashCode * 59 + this.CompanyOfficeNumber.GetHashCode();
                if (this.CompanyOfficeNumberCountry != null)
                    hashCode = hashCode * 59 + this.CompanyOfficeNumberCountry.GetHashCode();
                if (this.AmlOfficerEmail != null)
                    hashCode = hashCode * 59 + this.AmlOfficerEmail.GetHashCode();
                if (this.AmlOfficerPhone != null)
                    hashCode = hashCode * 59 + this.AmlOfficerPhone.GetHashCode();
                if (this.AmlOfficerPhoneCountry != null)
                    hashCode = hashCode * 59 + this.AmlOfficerPhoneCountry.GetHashCode();
                if (this.CompanyWebsiteUrl != null)
                    hashCode = hashCode * 59 + this.CompanyWebsiteUrl.GetHashCode();
                if (this.TaxIdentificationNo != null)
                    hashCode = hashCode * 59 + this.TaxIdentificationNo.GetHashCode();
                if (this.NumberOfEmployeesInCompany != null)
                    hashCode = hashCode * 59 + this.NumberOfEmployeesInCompany.GetHashCode();
                if (this.ListOfCountriesOfOperation != null)
                    hashCode = hashCode * 59 + this.ListOfCountriesOfOperation.GetHashCode();
                if (this.EstimatedAnnualRevenueTurnover != null)
                    hashCode = hashCode * 59 + this.EstimatedAnnualRevenueTurnover.GetHashCode();
