...
namespace TransferZero.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PayoutMethodDetailsVNDMobile :  IEquatable<PayoutMethodDetailsVNDMobile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayoutMethodDetailsVNDMobile" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayoutMethodDetailsVNDMobile() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayoutMethodDetailsVNDMobile" /> class.
        /// </summary>
        ...
        public PayoutMethodDetailsVNDMobile(string firstName = default(string), string lastName = default(string), string phoneNumber = default(string), string mobileProvider = default(string), string street = default(string), PayoutMethodTransferReasonEnum transferReason = default(PayoutMethodTransferReasonEnum))
        {
        ...
        {
            return this.Equals(input as PayoutMethodDetailsVNDMobile);
        }

        /// <summary>
        /// Returns true if PayoutMethodDetailsVNDMobile instances are equal
        /// </summary>
        /// <param name="input">Instance of PayoutMethodDetailsVNDMobile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayoutMethodDetailsVNDMobile input)
        {
            if (input == null)
                return false;
