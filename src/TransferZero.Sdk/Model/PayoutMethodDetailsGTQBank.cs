...
namespace TransferZero.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PayoutMethodDetailsGTQBank :  IEquatable<PayoutMethodDetailsGTQBank>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayoutMethodDetailsGTQBank" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayoutMethodDetailsGTQBank() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayoutMethodDetailsGTQBank" /> class.
        /// </summary>
        ...
        public PayoutMethodDetailsGTQBank(string firstName = default(string), string lastName = default(string), string identityCardId = default(string), string bankCode = default(string), string bankAccount = default(string), PayoutMethodBankAccountTypeEnum bankAccountType = default(PayoutMethodBankAccountTypeEnum))
        {
        ...
        {
            return this.Equals(input as PayoutMethodDetailsGTQBank);
        }

        /// <summary>
        /// Returns true if PayoutMethodDetailsGTQBank instances are equal
        /// </summary>
        /// <param name="input">Instance of PayoutMethodDetailsGTQBank to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayoutMethodDetailsGTQBank input)
        {
            if (input == null)
                return false;
