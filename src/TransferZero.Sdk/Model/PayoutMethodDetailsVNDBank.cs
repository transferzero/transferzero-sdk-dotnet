...
namespace TransferZero.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PayoutMethodDetailsVNDBank :  IEquatable<PayoutMethodDetailsVNDBank>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayoutMethodDetailsVNDBank" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayoutMethodDetailsVNDBank() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayoutMethodDetailsVNDBank" /> class.
        /// </summary>
        ...
        public PayoutMethodDetailsVNDBank(string firstName = default(string), string lastName = default(string), string bankAccount = default(string), string bankCode = default(string), PayoutMethodTransferReasonEnum transferReason = default(PayoutMethodTransferReasonEnum))
        {
        ...
        {
            return this.Equals(input as PayoutMethodDetailsVNDBank);
        }

        /// <summary>
        /// Returns true if PayoutMethodDetailsVNDBank instances are equal
        /// </summary>
        /// <param name="input">Instance of PayoutMethodDetailsVNDBank to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayoutMethodDetailsVNDBank input)
        {
            if (input == null)
                return false;
